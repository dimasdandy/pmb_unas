...
public class webview_pdf_reguler extends AppCompatActivity {
    public WebView webView;
    public ProgressBar progressBar;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_webview_pdf_reguler);
        ...
        webView.loadUrl("https://drive.google.com/file/d/1ICIOPB0-eSbrtoZgnq_bASGjUBwBq37L/view?usp=sharing");
