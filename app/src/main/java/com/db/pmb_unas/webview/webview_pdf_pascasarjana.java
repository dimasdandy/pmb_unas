...
public class webview_pdf_pascasarjana extends AppCompatActivity {
    public WebView webView;
    public ProgressBar progressBar;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_webview_pdf_pascasarjana);
        ...
        webView.loadUrl("https://drive.google.com/file/d/1XvjHxknEovn6oXOyDdopd_vH5uN_TJV8/view?usp=sharing");
