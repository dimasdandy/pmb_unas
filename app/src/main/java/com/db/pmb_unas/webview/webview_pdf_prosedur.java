...
public class webview_pdf_prosedur extends AppCompatActivity {
    public WebView webView;
    public ProgressBar progressBar;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_webview_pdf_prosedur);
        ...
        webView.loadUrl("https://drive.google.com/file/d/178AbM5h0zKCx81QpR2_hGheocG3147_c/view?usp=sharing");
