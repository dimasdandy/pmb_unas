...
public class webview_pdf_beasiswa extends AppCompatActivity {
    public WebView webView;
    public ProgressBar progressBar;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_webview_pdf_beasiswa);
        ...
        webView.loadUrl("https://drive.google.com/file/d/1YvJilMviggdUaQljtwqy4Kqfu7350S_C/view?usp=sharing");
