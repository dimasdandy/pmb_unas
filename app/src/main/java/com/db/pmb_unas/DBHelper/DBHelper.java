package com.db.pmb_unas.DBHelper;
...
public class DBHelper extends SQLiteAssetHelper {
    private static final String DB_NAME = "SoalPmb.db";
    ...
    //Get All Category From DB
     ...
     //Gett 20 question from DB by category
    public List<Question> getQuestionByCategory(int category){
        SQLiteDatabase db = instance.getWritableDatabase();
        Cursor cursor = db.rawQuery(String.format("SELECT * FROM Question WHERE CategoryID = %d ORDER BY RANDOM() LIMIT 60",category),null);
